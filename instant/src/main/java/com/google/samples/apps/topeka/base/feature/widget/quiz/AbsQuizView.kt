...
package com.google.samples.apps.topeka.instant.widget.quiz
...
import com.google.samples.apps.topeka.instant.activity.QuizActivity
...
import com.google.samples.apps.topeka.instant.widget.fab.CheckableFab

const val KEY_ANSWER = "answer"

/**
 * This is the base class for displaying a [com.google.samples.apps.topeka.instant.model.quiz.Quiz].
 *
 *
 ...
 * @param <Q> The type of [com.google.samples.apps.topeka.instant.model.quiz.Quiz] you want to
 * display.
</Q> */
...
(context: Context, private val category: Category, val quiz: Q) : FrameLayout(context) {
     ...
     * [com.google.samples.apps.topeka.instant.model.quiz.Quiz] they want to display.
